        ...
        <div class="header-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="home.blade.php"><img src="../images/logo.png" alt=""></a>
                        </div><!-- end logo -->
                    </div>
                </div><!-- end row -->
            </div><!-- end header-logo -->
                ...
                <nav class="navbar navbar-inverse navbar-toggleable-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active color-pink-hover" href="blog-category-01.blade.php">Fashion</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="portfolio row">
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <span class="bg-pink"><a href="blog-category-01.blade.php" title="">Fashion</a></span>
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            ...
                                            <small><a href="blog-category-01.blade.php" title="">19 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            ...
                                            <small><a href="blog-category-01.blade.php" title="">18 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            ...
                                            <small><a href="blog-author.html" title="">By: Jessica</a></small>
                                            <small><a href="blog-category-01.blade.php" title="">16 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="../upload/author_Hoanh.jpg" alt="" class="img-fluid">
                                                <div class="hovereffect">
                                                    <span></span>
                                                </div><!-- end hover -->
                                            </a>
                                        ...
                                        <div class="blog-meta">
                                            ...
                                            <small><a href="blog-author.html" title="">By: Jenny</a></small>
                                            <small><a href="blog-category-01.blade.php" title="">14 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            ...
                                            <small><a href="blog-author.html" title="">By: Amanda</a></small>
                                            <small><a href="blog-category-01.blade.php" title="">13 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                                ...
                                <div class="pitem item-w1 item-h1">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <span class="bg-pink"><a href="blog-category-01.blade.php" title="">Fashion</a></span>
                                            <h4><a href="single.html" title="">Grab a summer with a cup of coffee</a></h4>
                                            <small><a href="blog-author.html" title="">By: Martines</a></small>
                                            <small><a href="blog-category-01.blade.php" title="">12 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
